...
## Принятые правки по ответу преподавателя

- Добавлен ранний аудит программных ресурсов (RAM/heap fragmentation/flash) как обязательный трек с Фазы 1.
- OTA перенесен в ранний этап (S1): фиксируем OTA-совместимую partition scheme и делаем ранний smoke-test.
- Зафиксирован риск блокировок цикла управления при SD flush: в roadmap добавлено требование неблокирующего/порционного flush.
- Для S6 добавлен явный сценарий ввода/сохранения Wi-Fi credentials через AP на первом запуске.
